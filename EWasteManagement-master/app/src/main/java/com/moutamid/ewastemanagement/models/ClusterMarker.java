...
public class ClusterMarker implements ClusterItem {
    ...
    private AddBusinessModel user;

    public ClusterMarker(LatLng position, String title, String snippet, String iconPicture, AddBusinessModel user) {
    ...
    public AddBusinessModel getUser() {
        return user;
    }

    public void setUser(AddBusinessModel user) {
        this.user = user;
    }
